...
const SYSTEM = `Antes de realizar qualquer ação, entenda o contexto e instrução recente do usuário, comando mais recente enviado por ele: Criar uma tela de verificação de permissões para o administrador confirmar quais papéis podem consultar e configurar a IA.
