  ...
  return (
    <Card className="mx-auto max-w-2xl">
      ...
      <CardContent className="space-y-6">
        <div className="rounded-lg border border-indigo-200 bg-indigo-50/50 p-4 dark:border-indigo-900/30 dark:bg-indigo-950/20 space-y-4 opacity-75">
          <div className="flex items-center gap-2">
            <Sparkles className="h-4 w-4 text-indigo-600" />
            <h4 className="text-sm font-bold">Controle da IA Assistente</h4>
          </div>
          <p className="text-[11px] text-muted-foreground leading-relaxed">
            A IA Assistente foi desativada permanentemente por diretriz administrativa v2.8.2.
          </p>
          <div className="flex items-center justify-between py-1 border-t border-indigo-100 dark:border-indigo-900/50 pt-4">
            <div className="space-y-0.5">
              <Label className="text-[12px] font-semibold">Status da IA (Offline Permanente)</Label>
              <p className="text-[10px] text-rose-600 font-medium italic">Funcionalidade de IA desativada pelo administrador.</p>
            </div>
